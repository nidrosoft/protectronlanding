                ...
                >
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-x-10 gap-y-6 md:gap-x-14 xl:gap-x-16">
                        {companyLogos.map((company, index) => (
                            ...
                            >
                                <img 
                                    src={`https://cdn.simpleicons.org/${company.name.toLowerCase().replace(' ', '')}/white`}
                                    alt={company.name}
                                    className="h-6 w-6"
                                    onError={(e) => {
                    ...
                    >
                        ...
                        <div className="mt-6 flex flex-wrap items-center gap-3">
                            ...
                            <span className="inline-flex items-center gap-2 rounded-full bg-tertiary px-3 py-1.5 text-sm font-medium text-secondary">
                                <img src="https://cdn.simpleicons.org/langchain" alt="LangChain" className="h-4 w-4" />
                                LangChain
                            </span>
                            <span className="inline-flex items-center gap-2 rounded-full bg-tertiary px-3 py-1.5 text-sm font-medium text-secondary">
                            ...
                            <span className="inline-flex items-center gap-2 rounded-full bg-tertiary px-3 py-1.5 text-sm font-medium text-secondary">
                                <img src="https://cdn.simpleicons.org/microsoft" alt="AutoGen" className="h-4 w-4" />
                                AutoGen
                            </span>
                            <span className="inline-flex items-center gap-2 rounded-full bg-tertiary px-3 py-1.5 text-sm font-medium text-secondary">
                                <img src="https://cdn.simpleicons.org/openai" alt="OpenAI" className="h-4 w-4" />
                                OpenAI
                            </span>
                        </div>
                    </motion.div>
